...
> **Relation to Other Specifications:** The interrupt handling framework was largely inspired by [the μITRON4.0 specification](http://www.ertl.jp/ITRON/SPEC/mitron4-e.html). The method of leveraging Rust's `unsafe` system to ensure unmanaged safety is obviously Rust-specific and novel.
>
...
>
> The OSEK/VDX specification divides interrupt service routines into categories 1 and 2 similarly to our managed and unmanaged interrupt handlers.
