//! The interrupt controller driver based on [`constance_port_riscv::use_plic!`]
...
pub(crate) const INTERRUPT_GPIO0: InterruptNum =
    constance_port_riscv::INTERRUPT_PLATFORM_START + e310x::Interrupt::GPIO0 as InterruptNum;
pub(crate) const INTERRUPT_GPIO1: InterruptNum =
    constance_port_riscv::INTERRUPT_PLATFORM_START + e310x::Interrupt::GPIO1 as InterruptNum;
